...
class Pguard < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://releases.getpguard.com/#{version}/pguard-darwin-arm64.tar.gz"
      sha256 "14b33661a853a88a807f3291ca27a8e60726cf1069c51b9f132e0aa3a824e533"
    else
      url "https://releases.getpguard.com/#{version}/pguard-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://releases.getpguard.com/#{version}/pguard-linux-arm64.tar.gz"
      sha256 "d387a195c19fe09fbe7313c7689e59b9b08b743d8aca455475868d49fbf9e57c"
    else
      url "https://releases.getpguard.com/#{version}/pguard-linux-amd64.tar.gz"
