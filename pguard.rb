...
class Pguard < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://releases.getpguard.com/2.13.0/pguard-darwin-amd64.tar.gz"
    ...
    if Hardware::CPU.arm?
      url "https://releases.getpguard.com/2.13.0/pguard-darwin-arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://releases.getpguard.com/2.13.0/pguard-linux-amd64.tar.gz"
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://releases.getpguard.com/2.13.0/pguard-linux-arm64.tar.gz"
